...
<x-email-layout>
    ...
    <div id = "wrapper" style = "max-width:640px;border-radius:10px;border:1px solid black;margin:0px auto 10px auto;padding:10px;background:whitesmoke;">
    <div id = "headerwrapper" style = "padding:10px;font-size:0.8em;">
    <div id = "logo" style = "display:inline-block;vertical-align:top;"><img height="60" style = "height:60px;width:auto;margin-left:10px;" src = "<?php echo $base64 ?>" ></div>
    <div id = "headerleft"  style = "display:inline-block;width:200px;margin-left:10px;"><?php echo $facility->name ?><br><?php echo $address ?><br><?php echo $city_state  ?> <?php echo $facility->postal_code  ?><br><?php echo $facility->country  ?><br><?php echo $facility->phone_ctry  ?> <?php echo $facility->phone ?><br><a href = "<?php echo $facility->website ?>" target = "_blank"><?php echo $facility->website ?></a><br><a href="mailto:<?php echo $facility->email ?>"><?php echo $facility->email ?></a></div>
    </div>
    <div id = "greeting">TO:  <?php echo $data['email'] ?><br>RE:  Radiology Report</div>
    <div id = "message" style = "margin:10px;">Please find a PDF of the requested report attached.</div>
